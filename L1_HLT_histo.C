...
TH1D *photons_nofire_HLT_eta =(TH1D*) file->Get("photons_nofire_HLT_eta");
...
*/
//-------------------------------------------------------------------//
//-------------L1EM Efficiency Dependent on Centrality---------------//
//-------------------------------------------------------------------//


TCanvas *new_l1em_pT_dis = new TCanvas("new_l1em_pT_dis","new_l1em_pT_dis",600,500);
TLegend *pT_new_dis = new TLegend(0.6,0.5,0.85,0.6);

photon_w_L1EM_15GeV_010->SetName("photon_w_L1EM_15GeV_010");
photon_w_L1EM_15GeV_010->GetXaxis()->SetTitle("p_{T} [GeV]");
photon_w_L1EM_15GeV_010->GetYaxis()->SetTitle("Counts");
photon_w_L1EM_15GeV_010->SetLineColor(kRed);
photon_w_L1EM_15GeV_010->SetMarkerColor(kRed);
photon_w_L1EM_15GeV_010->SetMarkerStyle(24);

photon_w_L1EM_15GeV_1030->SetLineColor(kBlue);
photon_w_L1EM_15GeV_1030->SetMarkerColor(kBlue);
photon_w_L1EM_15GeV_1030->SetMarkerStyle(25);

photon_w_L1EM_15GeV_3050->SetLineColor(kMagenta);
photon_w_L1EM_15GeV_3050->SetMarkerColor(kMagenta);
photon_w_L1EM_15GeV_3050->SetMarkerStyle(26);

photon_w_L1EM_15GeV_5080->SetLineColor(kGreen);
photon_w_L1EM_15GeV_5080->SetMarkerColor(kGreen);
photon_w_L1EM_15GeV_5080->SetMarkerStyle(27);


photon_w_L1EM_15GeV_010->Draw();
photon_w_L1EM_15GeV_1030->Draw("same");
photon_w_L1EM_15GeV_3050->Draw("same");
photon_w_L1EM_15GeV_5080->Draw("same");

TPaveText *l1em_photon_00 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
l1em_photon_00->SetTextSize(0.03);
l1em_photon_00->SetFillColor(0);
l1em_photon_00->SetBorderSize(0);
l1em_photon_00->SetShadowColor(0);
l1em_photon_00->SetTextAlign(21);
l1em_photon_00->AddText("");
l1em_photon_00->AddText("Pb+Pb");
l1em_photon_00->AddText("Tight Photons");
l1em_photon_00->AddText("p^{#gamma}_{T} > 15 GeV");
l1em_photon_00->AddText("L1 RoI p_{T} > 15 GeV");
l1em_photon_00->AddText("DeltaR < 0.15");
l1em_photon_00->SetTextSize(0.036);

l1em_photon_00->Draw("same");


pT_new_dis->AddEntry("photon_w_L1EM_15GeV_010","0-10%","l");
pT_new_dis->AddEntry("photon_w_L1EM_15GeV_1030","10-30%", "l");
pT_new_dis->AddEntry("photon_w_L1EM_15GeV_3050","30-50%","l");
pT_new_dis->AddEntry("photon_w_L1EM_15GeV_5080","50-80%","l");
pT_new_dis->SetTextSize(0.03);
pT_new_dis->Draw("same");
...
TH1D* L1EM_eff_010 = new TH1D("L1EM_eff_010","",40,0,200);
L1EM_eff_010->SetName("L1EM_eff_010");                                                                                                                           
L1EM_eff_010->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010->SetMarkerStyle(24);
L1EM_eff_010->SetTitle("L1EM Efficiency");
L1EM_eff_010->SetLineColor(kRed);
L1EM_eff_010->SetMarkerColor(kRed);
L1EM_eff_010->Divide(photon_w_L1EM_15GeV_010,all_photons_010,1,1,"B");
L1EM_eff_010->SetMaximum(1.1);

TH1D *L1EM_eff_1030 = new TH1D("L1EM_eff_1030","",40,0,200);
L1EM_eff_1030->SetName("L1EM_eff_1030");
L1EM_eff_1030->SetMarkerStyle(25);
L1EM_eff_1030->SetMarkerColor(kBlue);
L1EM_eff_1030->SetLineColor(kBlue);
L1EM_eff_1030->Divide(photon_w_L1EM_15GeV_1030,all_photons_1030,1,1,"B");

TH1D *L1EM_eff_3050 = new TH1D("L1EM_eff_3050","",40,0,200);
L1EM_eff_3050->SetName("L1EM_eff_3050");
L1EM_eff_3050->SetMarkerStyle(26);
L1EM_eff_3050->SetMarkerColor(kMagenta);
L1EM_eff_3050->SetLineColor(kMagenta);
L1EM_eff_3050->Divide(photon_w_L1EM_15GeV_3050,all_photons_3050,1,1,"B");

TH1D *L1EM_eff_5080 = new TH1D("L1EM_eff_5080","",40,0,200);
L1EM_eff_5080->SetName("L1EM_eff_5080");
L1EM_eff_5080->SetMarkerStyle(27);
L1EM_eff_5080->SetMarkerColor(kGreen);
L1EM_eff_5080->SetLineColor(kGreen);
L1EM_eff_5080->Divide(photon_w_L1EM_15GeV_5080,all_photons_5080,1,1,"B");
...
l1em_photon_0->AddText("L1 RoI p_{T} > 15 GeV");
...
L1EM_eff_010->Draw();
L1EM_eff_1030->Draw("same");
L1EM_eff_3050->Draw("same");
L1EM_eff_5080->Draw("same");

l1em_photon_0->Draw("same");

new_lg_l1em_cent->AddEntry("L1EM_eff_010","0-10%","pe");
new_lg_l1em_cent->AddEntry("L1EM_eff_1030","10-30%","pe");
new_lg_l1em_cent->AddEntry("L1EM_eff_3050","30-50%","pe");
new_lg_l1em_cent->AddEntry("L1EM_eff_5080","50-80%","pe");
...
//------L1EM pT > 25 GeV
TCanvas *new_l1em_eff_cent_25 = new TCanvas("new_l1em_eff_cent_25","new_l1em_eff_cent_25",600,500);
TLegend *new_lg_l1em_cent_25 = new TLegend(0.6,0.5,0.85,0.6);

TH1D* L1EM_eff_010_25GeV = new TH1D("L1EM_eff_010_25GeV","",40,0,200);
L1EM_eff_010_25GeV->SetName("L1EM_eff_010_25GeV");                                                                                                                           
L1EM_eff_010_25GeV->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_25GeV->SetMarkerStyle(24);
L1EM_eff_010_25GeV->SetTitle("L1EM Efficiency");
L1EM_eff_010_25GeV->SetLineColor(kRed);
L1EM_eff_010_25GeV->SetMarkerColor(kRed);
L1EM_eff_010_25GeV->Divide(photon_w_L1EM_25GeV_010,all_photons_010,1,1,"B");
L1EM_eff_010_25GeV->SetMaximum(1.1);

TH1D *L1EM_eff_1030_25GeV = new TH1D("L1EM_eff_1030","",40,0,200);
...
L1EM_eff_1030_25GeV->Divide(photon_w_L1EM_25GeV_1030,all_photons_1030,1,1,"B");

TH1D *L1EM_eff_3050_25GeV = new TH1D("L1EM_eff_3050","",40,0,200);
L1EM_eff_3050_25GeV->SetName("L1EM_eff_3050_25GeV");
L1EM_eff_3050_25GeV->SetMarkerStyle(26);
L1EM_eff_3050_25GeV->SetMarkerColor(kMagenta);
L1EM_eff_3050_25GeV->SetLineColor(kMagenta);
L1EM_eff_3050_25GeV->Divide(photon_w_L1EM_25GeV_3050,all_photons_3050,1,1,"B");

TH1D *L1EM_eff_5080_25GeV = new TH1D("L1EM_eff_5080_25GeV","",40,0,200);
L1EM_eff_5080_25GeV->SetName("L1EM_eff_5080_25GeV");
L1EM_eff_5080_25GeV->SetMarkerStyle(27);
L1EM_eff_5080_25GeV->SetMarkerColor(kGreen);
L1EM_eff_5080_25GeV->SetLineColor(kGreen);
L1EM_eff_5080_25GeV->Divide(photon_w_L1EM_25GeV_5080,all_photons_5080,1,1,"B");

TPaveText *l1em_photon_01 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
l1em_photon_01->SetTextSize(0.03);
l1em_photon_01->SetFillColor(0);
l1em_photon_01->SetBorderSize(0);
l1em_photon_01->SetShadowColor(0);
l1em_photon_01->SetTextAlign(21);
l1em_photon_01->AddText("");
l1em_photon_01->AddText("Pb+Pb");
l1em_photon_01->AddText("Tight Photons");
l1em_photon_01->AddText("p^{#gamma}_{T} > 15 GeV");
l1em_photon_01->AddText("L1 RoI p_{T} > 25 GeV");
l1em_photon_01->AddText("DeltaR < 0.15");
l1em_photon_01->SetTextSize(0.036);





L1EM_eff_010_25GeV->Draw();
L1EM_eff_1030_25GeV->Draw("same");
L1EM_eff_3050_25GeV->Draw("same");
L1EM_eff_5080_25GeV->Draw("same");

l1em_photon_01->Draw("same");

new_lg_l1em_cent_25->AddEntry("L1EM_eff_010_25GeV","0-10%","pe");
new_lg_l1em_cent_25->AddEntry("L1EM_eff_1030_25GeV","10-30%","pe");
new_lg_l1em_cent_25->AddEntry("L1EM_eff_3050_25GeV","30-50%","pe");
new_lg_l1em_cent_25->AddEntry("L1EM_eff_5080_25GeV","50-80%","pe");


new_lg_l1em_cent_25->Draw("same");


//------L1EM pT > 35 GeV
TCanvas *new_l1em_eff_cent_35 = new TCanvas("new_l1em_eff_cent_35","new_l1em_eff_cent_35",600,500);
TLegend *new_lg_l1em_cent_35 = new TLegend(0.6,0.5,0.85,0.6);

TH1D* L1EM_eff_010_35GeV = new TH1D("L1EM_eff_010_35GeV","",40,0,200);
L1EM_eff_010_35GeV->SetName("L1EM_eff_010_35GeV");                                                                                                                           
L1EM_eff_010_35GeV->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_35GeV->SetMarkerStyle(24);
L1EM_eff_010_35GeV->SetTitle("L1EM Efficiency");
L1EM_eff_010_35GeV->SetLineColor(kRed);
L1EM_eff_010_35GeV->SetMarkerColor(kRed);
L1EM_eff_010_35GeV->Divide(photon_w_L1EM_35GeV_010,all_photons_010,1,1,"B");
L1EM_eff_010_35GeV->SetMaximum(1.1);

TH1D *L1EM_eff_1030_35GeV = new TH1D("L1EM_eff_1030_35GeV","",40,0,200);
L1EM_eff_1030_35GeV->SetName("L1EM_eff_1030_35GeV");
L1EM_eff_1030_35GeV->SetMarkerStyle(25);
L1EM_eff_1030_35GeV->SetMarkerColor(kBlue);
L1EM_eff_1030_35GeV->SetLineColor(kBlue);
L1EM_eff_1030_35GeV->Divide(photon_w_L1EM_35GeV_1030,all_photons_1030,1,1,"B");

TH1D *L1EM_eff_3050_35GeV = new TH1D("L1EM_eff_3050","",40,0,200);
...
L1EM_eff_3050_35GeV->Divide(photon_w_L1EM_35GeV_3050,all_photons_3050,1,1,"B");

TH1D *L1EM_eff_5080_35GeV = new TH1D("L1EM_eff_5080_35GeV","",40,0,200);
L1EM_eff_5080_35GeV->SetName("L1EM_eff_5080_35GeV");
L1EM_eff_5080_35GeV->SetMarkerStyle(27);
L1EM_eff_5080_35GeV->SetMarkerColor(kGreen);
L1EM_eff_5080_35GeV->SetLineColor(kGreen);
L1EM_eff_5080_35GeV->Divide(photon_w_L1EM_35GeV_5080,all_photons_5080,1,1,"B");

TPaveText *l1em_photon_02 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
l1em_photon_02->SetTextSize(0.03);
l1em_photon_02->SetFillColor(0);
l1em_photon_02->SetBorderSize(0);
l1em_photon_02->SetShadowColor(0);
l1em_photon_02->SetTextAlign(21);
l1em_photon_02->AddText("");
l1em_photon_02->AddText("Pb+Pb");
l1em_photon_02->AddText("Tight Photons");
l1em_photon_02->AddText("p^{#gamma}_{T} > 15 GeV");
l1em_photon_02->AddText("L1 RoI p_{T} > 35 GeV");
l1em_photon_02->AddText("DeltaR < 0.15");
l1em_photon_02->SetTextSize(0.036);



L1EM_eff_010_35GeV->Draw();
L1EM_eff_1030_35GeV->Draw("same");
L1EM_eff_3050_35GeV->Draw("same");
L1EM_eff_5080_35GeV->Draw("same");

l1em_photon_02->Draw("same");

new_lg_l1em_cent_35->AddEntry("L1EM_eff_010_35GeV","0-10%","pe");
new_lg_l1em_cent_35->AddEntry("L1EM_eff_1030_35GeV","10-30%","pe");
new_lg_l1em_cent_35->AddEntry("L1EM_eff_3050_35GeV","30-50%","pe");
new_lg_l1em_cent_35->AddEntry("L1EM_eff_5080_35GeV","50-80%","pe");


new_lg_l1em_cent_35->Draw("same");
...
TH1D* L1EM_eff_010_b = new TH1D("L1EM_eff_010_b","",40,0,200);
L1EM_eff_010_b->SetName("L1EM_eff_010_b");                                                                                                                           
L1EM_eff_010_b->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_b->SetMarkerStyle(24);
L1EM_eff_010_b->SetTitle("L1EM Efficiency");
L1EM_eff_010_b->SetLineColor(kRed);
L1EM_eff_010_b->SetMarkerColor(kRed);
L1EM_eff_010_b->Divide(photon_w_L1EM_15GeV_010_b,all_photons_010_b,1,1,"B");
L1EM_eff_010_b->SetMaximum(1.1);

TH1D *L1EM_eff_1030_b = new TH1D("L1EM_eff_1030_b","",40,0,200);
L1EM_eff_1030_b->SetName("L1EM_eff_1030_b");
L1EM_eff_1030_b->SetMarkerStyle(25);
L1EM_eff_1030_b->SetMarkerColor(kBlue);
L1EM_eff_1030_b->SetLineColor(kBlue);
L1EM_eff_1030_b->Divide(photon_w_L1EM_15GeV_1030_b,all_photons_1030_b,1,1,"B");

TH1D *L1EM_eff_3050_b = new TH1D("L1EM_eff_3050_b","",40,0,200);
L1EM_eff_3050_b->SetName("L1EM_eff_3050_b");
L1EM_eff_3050_b->SetMarkerStyle(26);
L1EM_eff_3050_b->SetMarkerColor(kMagenta);
L1EM_eff_3050_b->SetLineColor(kMagenta);
L1EM_eff_3050_b->Divide(photon_w_L1EM_15GeV_3050_b,all_photons_3050_b,1,1,"B");

TH1D *L1EM_eff_5080_b = new TH1D("L1EM_eff_5080_b","",40,0,200);
L1EM_eff_5080_b->SetName("L1EM_eff_5080_b");
L1EM_eff_5080_b->SetMarkerStyle(27);
L1EM_eff_5080_b->SetMarkerColor(kGreen);
L1EM_eff_5080_b->SetLineColor(kGreen);
L1EM_eff_5080_b->Divide(photon_w_L1EM_15GeV_5080_b,all_photons_5080_b,1,1,"B");
...
l1em_photon_0_b->AddText("L1 RoI p_{T} > 15 GeV");
...
L1EM_eff_010_b->Draw();
L1EM_eff_1030_b->Draw("same");
L1EM_eff_3050_b->Draw("same");
L1EM_eff_5080_b->Draw("same");

l1em_photon_0_b->Draw("same");

new_lg_l1em_cent_b->AddEntry("L1EM_eff_010_b","0-10%","pe");
new_lg_l1em_cent_b->AddEntry("L1EM_eff_1030_b","10-30%","pe");
new_lg_l1em_cent_b->AddEntry("L1EM_eff_3050_b","30-50%","pe");
new_lg_l1em_cent_b->AddEntry("L1EM_eff_5080_b","50-80%","pe");
...
//------L1EM pT > 25 GeV
TCanvas *new_l1em_eff_cent_25_b = new TCanvas("new_l1em_eff_cent_25_b","new_l1em_eff_cent_25_b",600,500);
TLegend *new_lg_l1em_cent_25_b = new TLegend(0.6,0.5,0.85,0.6);

TH1D* L1EM_eff_010_25GeV_b = new TH1D("L1EM_eff_010_25GeV_b","",40,0,200);
L1EM_eff_010_25GeV_b->SetName("L1EM_eff_010_25GeV_b");                                                                                                                           
L1EM_eff_010_25GeV_b->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_25GeV_b->SetMarkerStyle(24);
L1EM_eff_010_25GeV_b->SetTitle("L1EM Efficiency");
L1EM_eff_010_25GeV_b->SetLineColor(kRed);
L1EM_eff_010_25GeV_b->SetMarkerColor(kRed);
L1EM_eff_010_25GeV_b->Divide(photon_w_L1EM_25GeV_010_b,all_photons_010_b,1,1,"B");
L1EM_eff_010_25GeV_b->SetMaximum(1.1);

TH1D *L1EM_eff_1030_25GeV_b = new TH1D("L1EM_eff_1030_25GeV_b","",40,0,200);
...
L1EM_eff_1030_25GeV_b->Divide(photon_w_L1EM_25GeV_1030_b,all_photons_1030_b,1,1,"B");

TH1D *L1EM_eff_3050_25GeV_b = new TH1D("L1EM_eff_3050_25GeV_b","",40,0,200);
L1EM_eff_3050_25GeV_b->SetName("L1EM_eff_3050_25GeV_b");
L1EM_eff_3050_25GeV_b->SetMarkerStyle(26);
L1EM_eff_3050_25GeV_b->SetMarkerColor(kMagenta);
L1EM_eff_3050_25GeV_b->SetLineColor(kMagenta);
L1EM_eff_3050_25GeV_b->Divide(photon_w_L1EM_25GeV_3050_b,all_photons_3050_b,1,1,"B");

TH1D *L1EM_eff_5080_25GeV_b = new TH1D("L1EM_eff_5080_25GeV_b","",40,0,200);
L1EM_eff_5080_25GeV_b->SetName("L1EM_eff_5080_25GeV_b");
L1EM_eff_5080_25GeV_b->SetMarkerStyle(27);
L1EM_eff_5080_25GeV_b->SetMarkerColor(kGreen);
L1EM_eff_5080_25GeV_b->SetLineColor(kGreen);
L1EM_eff_5080_25GeV_b->Divide(photon_w_L1EM_25GeV_5080_b,all_photons_5080_b,1,1,"B");

TPaveText *l1em_photon_01_b = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
l1em_photon_01_b->SetTextSize(0.03);
l1em_photon_01_b->SetFillColor(0);
l1em_photon_01_b->SetBorderSize(0);
l1em_photon_01_b->SetShadowColor(0);
l1em_photon_01_b->SetTextAlign(21);
l1em_photon_01_b->AddText("");
l1em_photon_01_b->AddText("Pb+Pb");
l1em_photon_01_b->AddText("Tight Photons");
l1em_photon_01_b->AddText("p^{#gamma}_{T} > 15 GeV");
l1em_photon_01_b->AddText("L1 RoI p_{T} > 25 GeV");
l1em_photon_01_b->AddText("DeltaR < 0.15");
l1em_photon_01_b->AddText("|#eta| < 1.37");
l1em_photon_01_b->SetTextSize(0.036);





L1EM_eff_010_25GeV_b->Draw();
L1EM_eff_1030_25GeV_b->Draw("same");
L1EM_eff_3050_25GeV_b->Draw("same");
L1EM_eff_5080_25GeV_b->Draw("same");

l1em_photon_01_b->Draw("same");

new_lg_l1em_cent_25_b->AddEntry("L1EM_eff_010_25GeV_b","0-10%","pe");
new_lg_l1em_cent_25_b->AddEntry("L1EM_eff_1030_25GeV_b","10-30%","pe");
new_lg_l1em_cent_25_b->AddEntry("L1EM_eff_3050_25GeV_b","30-50%","pe");
new_lg_l1em_cent_25_b->AddEntry("L1EM_eff_5080_25GeV_b","50-80%","pe");


new_lg_l1em_cent_25_b->Draw("same");


//------L1EM pT > 35 GeV
TCanvas *new_l1em_eff_cent_35_b = new TCanvas("new_l1em_eff_cent_35_b","new_l1em_eff_cent_35_b",600,500);
TLegend *new_lg_l1em_cent_35_b = new TLegend(0.6,0.5,0.85,0.6);

TH1D* L1EM_eff_010_35GeV_b = new TH1D("L1EM_eff_010_35GeV_b","",40,0,200);
L1EM_eff_010_35GeV_b->SetName("L1EM_eff_010_35GeV_b");                                                                                                                           
L1EM_eff_010_35GeV_b->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_35GeV_b->SetMarkerStyle(24);
L1EM_eff_010_35GeV_b->SetTitle("L1EM Efficiency");
L1EM_eff_010_35GeV_b->SetLineColor(kRed);
L1EM_eff_010_35GeV_b->SetMarkerColor(kRed);
L1EM_eff_010_35GeV_b->Divide(photon_w_L1EM_35GeV_010_b,all_photons_010_b,1,1,"B");
L1EM_eff_010_35GeV_b->SetMaximum(1.1);

TH1D *L1EM_eff_1030_35GeV_b = new TH1D("L1EM_eff_1030_35GeV_b","",40,0,200);
L1EM_eff_1030_35GeV_b->SetName("L1EM_eff_1030_35GeV_b");
L1EM_eff_1030_35GeV_b->SetMarkerStyle(25);
L1EM_eff_1030_35GeV_b->SetMarkerColor(kBlue);
L1EM_eff_1030_35GeV_b->SetLineColor(kBlue);
L1EM_eff_1030_35GeV_b->Divide(photon_w_L1EM_35GeV_1030_b,all_photons_1030_b,1,1,"B");

TH1D *L1EM_eff_3050_35GeV_b = new TH1D("L1EM_eff_3050_35GeV_b","",40,0,200);
...
L1EM_eff_3050_35GeV_b->Divide(photon_w_L1EM_35GeV_3050_b,all_photons_3050_b,1,1,"B");

TH1D *L1EM_eff_5080_35GeV_b = new TH1D("L1EM_eff_5080_35GeV_b","",40,0,200);
L1EM_eff_5080_35GeV_b->SetName("L1EM_eff_5080_35GeV_b");
L1EM_eff_5080_35GeV_b->SetMarkerStyle(27);
L1EM_eff_5080_35GeV_b->SetMarkerColor(kGreen);
L1EM_eff_5080_35GeV_b->SetLineColor(kGreen);
L1EM_eff_5080_35GeV_b->Divide(photon_w_L1EM_35GeV_5080_b,all_photons_5080_b,1,1,"B");

TPaveText *l1em_photon_03 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
l1em_photon_03->SetTextSize(0.03);
l1em_photon_03->SetFillColor(0);
l1em_photon_03->SetBorderSize(0);
l1em_photon_03->SetShadowColor(0);
l1em_photon_03->SetTextAlign(21);
l1em_photon_03->AddText("");
l1em_photon_03->AddText("Pb+Pb");
l1em_photon_03->AddText("Tight Photons");
l1em_photon_03->AddText("p^{#gamma}_{T} > 15 GeV");
l1em_photon_03->AddText("L1 RoI p_{T} > 35 GeV");
l1em_photon_03->AddText("DeltaR < 0.15");
l1em_photon_03->AddText("|#eta| < 1.37");
l1em_photon_03->SetTextSize(0.036);



L1EM_eff_010_35GeV_b->Draw();
L1EM_eff_1030_35GeV_b->Draw("same");
L1EM_eff_3050_35GeV_b->Draw("same");
L1EM_eff_5080_35GeV_b->Draw("same");

l1em_photon_03->Draw("same");

new_lg_l1em_cent_35_b->AddEntry("L1EM_eff_010_35GeV_b","0-10%","pe");
new_lg_l1em_cent_35_b->AddEntry("L1EM_eff_1030_35GeV_b","10-30%","pe");
new_lg_l1em_cent_35_b->AddEntry("L1EM_eff_3050_35GeV_b","30-50%","pe");
new_lg_l1em_cent_35_b->AddEntry("L1EM_eff_5080_35GeV_b","50-80%","pe");


new_lg_l1em_cent_35_b->Draw("same");
...
TH1D* L1EM_eff_010_e = new TH1D("L1EM_eff_010_e","",40,0,200);
L1EM_eff_010_e->SetName("L1EM_eff_010_e");                                                                                                                           
L1EM_eff_010_e->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_e->SetMarkerStyle(24);
L1EM_eff_010_e->SetTitle("L1EM Efficiency");
L1EM_eff_010_e->SetLineColor(kRed);
L1EM_eff_010_e->SetMarkerColor(kRed);
L1EM_eff_010_e->Divide(photon_w_L1EM_15GeV_010_e,all_photons_010_e,1,1,"B");
L1EM_eff_010_e->SetMaximum(1.1);

TH1D *L1EM_eff_1030_e = new TH1D("L1EM_eff_1030_e","",40,0,200);
L1EM_eff_1030_e->SetName("L1EM_eff_1030_e");
L1EM_eff_1030_e->SetMarkerStyle(25);
L1EM_eff_1030_e->SetMarkerColor(kBlue);
L1EM_eff_1030_e->SetLineColor(kBlue);
L1EM_eff_1030_e->Divide(photon_w_L1EM_15GeV_1030_e,all_photons_1030_e,1,1,"B");

TH1D *L1EM_eff_3050_e = new TH1D("L1EM_eff_3050_e","",40,0,200);
L1EM_eff_3050_e->SetName("L1EM_eff_3050_e");
L1EM_eff_3050_e->SetMarkerStyle(26);
L1EM_eff_3050_e->SetMarkerColor(kMagenta);
L1EM_eff_3050_e->SetLineColor(kMagenta);
L1EM_eff_3050_e->Divide(photon_w_L1EM_15GeV_3050_e,all_photons_3050_e,1,1,"B");

TH1D *L1EM_eff_5080_e = new TH1D("L1EM_eff_5080_e","",40,0,200);
L1EM_eff_5080_e->SetName("L1EM_eff_5080_e");
L1EM_eff_5080_e->SetMarkerStyle(27);
L1EM_eff_5080_e->SetMarkerColor(kGreen);
L1EM_eff_5080_e->SetLineColor(kGreen);
L1EM_eff_5080_e->Divide(photon_w_L1EM_15GeV_5080_e,all_photons_5080_e,1,1,"B");
...
l1em_photon_0_e->AddText("L1 RoI p_{T} > 15 GeV");
...
L1EM_eff_010_e->Draw();
L1EM_eff_1030_e->Draw("same");
L1EM_eff_3050_e->Draw("same");
L1EM_eff_5080_e->Draw("same");

l1em_photon_0_e->Draw("same");

new_lg_l1em_cent_e->AddEntry("L1EM_eff_010_e","0-10%","pe");
new_lg_l1em_cent_e->AddEntry("L1EM_eff_1030_e","10-30%","pe");
new_lg_l1em_cent_e->AddEntry("L1EM_eff_3050_e","30-50%","pe");
new_lg_l1em_cent_e->AddEntry("L1EM_eff_5080_e","50-80%","pe");
...
//------L1EM pT > 25 GeV
TCanvas *new_l1em_eff_cent_25_e = new TCanvas("new_l1em_eff_cent_25_e","new_l1em_eff_cent_25_e",600,500);
TLegend *new_lg_l1em_cent_25_e = new TLegend(0.6,0.5,0.85,0.6);

TH1D* L1EM_eff_010_25GeV_e = new TH1D("L1EM_eff_010_25GeV_e","",40,0,200);
L1EM_eff_010_25GeV_e->SetName("L1EM_eff_010_25GeV_e");                                                                                                                           
L1EM_eff_010_25GeV_e->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_25GeV_e->SetMarkerStyle(24);
L1EM_eff_010_25GeV_e->SetTitle("L1EM Efficiency");
L1EM_eff_010_25GeV_e->SetLineColor(kRed);
L1EM_eff_010_25GeV_e->SetMarkerColor(kRed);
L1EM_eff_010_25GeV_e->Divide(photon_w_L1EM_25GeV_010_e,all_photons_010_e,1,1,"B");
L1EM_eff_010_25GeV_e->SetMaximum(1.1);

TH1D *L1EM_eff_1030_25GeV_e = new TH1D("L1EM_eff_1030_25GeV_e","",40,0,200);
...
L1EM_eff_1030_25GeV_e->Divide(photon_w_L1EM_25GeV_1030_e,all_photons_1030_e,1,1,"B");

TH1D *L1EM_eff_3050_25GeV_e = new TH1D("L1EM_eff_3050_25GeV_e","",40,0,200);
L1EM_eff_3050_25GeV_e->SetName("L1EM_eff_3050_25GeV_e");
L1EM_eff_3050_25GeV_e->SetMarkerStyle(26);
L1EM_eff_3050_25GeV_e->SetMarkerColor(kMagenta);
L1EM_eff_3050_25GeV_e->SetLineColor(kMagenta);
L1EM_eff_3050_25GeV_e->Divide(photon_w_L1EM_25GeV_3050_e,all_photons_3050_e,1,1,"B");

TH1D *L1EM_eff_5080_25GeV_e = new TH1D("L1EM_eff_5080_25GeV_e","",40,0,200);
L1EM_eff_5080_25GeV_e->SetName("L1EM_eff_5080_25GeV_e");
L1EM_eff_5080_25GeV_e->SetMarkerStyle(27);
L1EM_eff_5080_25GeV_e->SetMarkerColor(kGreen);
L1EM_eff_5080_25GeV_e->SetLineColor(kGreen);
L1EM_eff_5080_25GeV_e->Divide(photon_w_L1EM_25GeV_5080_e,all_photons_5080_e,1,1,"B");

TPaveText *l1em_photon_01_e = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
l1em_photon_01_e->SetTextSize(0.03);
l1em_photon_01_e->SetFillColor(0);
l1em_photon_01_e->SetBorderSize(0);
l1em_photon_01_e->SetShadowColor(0);
l1em_photon_01_e->SetTextAlign(21);
l1em_photon_01_e->AddText("");
l1em_photon_01_e->AddText("Pb+Pb");
l1em_photon_01_e->AddText("Tight Photons");
l1em_photon_01_e->AddText("p^{#gamma}_{T} > 15 GeV");
l1em_photon_01_e->AddText("L1 RoI p_{T} > 25 GeV");
l1em_photon_01_e->AddText("DeltaR < 0.15");
l1em_photon_01_e->AddText("1.56 < |#eta| < 2.37");
l1em_photon_01_e->SetTextSize(0.036);





L1EM_eff_010_25GeV_e->Draw();
L1EM_eff_1030_25GeV_e->Draw("same");
L1EM_eff_3050_25GeV_e->Draw("same");
L1EM_eff_5080_25GeV_e->Draw("same");

l1em_photon_01_e->Draw("same");

new_lg_l1em_cent_25_e->AddEntry("L1EM_eff_010_25GeV_e","0-10%","pe");
new_lg_l1em_cent_25_e->AddEntry("L1EM_eff_1030_25GeV_e","10-30%","pe");
new_lg_l1em_cent_25_e->AddEntry("L1EM_eff_3050_25GeV_e","30-50%","pe");
new_lg_l1em_cent_25_e->AddEntry("L1EM_eff_5080_25GeV_e","50-80%","pe");


new_lg_l1em_cent_25_e->Draw("same");


//------L1EM pT > 35 GeV
TCanvas *new_l1em_eff_cent_35_e = new TCanvas("new_l1em_eff_cent_35_e","new_l1em_eff_cent_35_e",600,500);
TLegend *new_lg_l1em_cent_35_e = new TLegend(0.6,0.5,0.85,0.6);

TH1D* L1EM_eff_010_35GeV_e = new TH1D("L1EM_eff_010_35GeV_e","",40,0,200);
L1EM_eff_010_35GeV_e->SetName("L1EM_eff_010_35GeV_e");                                                                                                                           
L1EM_eff_010_35GeV_e->GetXaxis()->SetTitle("p_{T} [GeV]");
L1EM_eff_010_35GeV_e->SetMarkerStyle(24);
L1EM_eff_010_35GeV_e->SetTitle("L1EM Efficiency");
L1EM_eff_010_35GeV_e->SetLineColor(kRed);
L1EM_eff_010_35GeV_e->SetMarkerColor(kRed);
L1EM_eff_010_35GeV_e->Divide(photon_w_L1EM_35GeV_010_e,all_photons_010_e,1,1,"B");
L1EM_eff_010_35GeV_e->SetMaximum(1.1);

TH1D *L1EM_eff_1030_35GeV_e = new TH1D("L1EM_eff_1030_35GeV_e","",40,0,200);
L1EM_eff_1030_35GeV_e->SetName("L1EM_eff_1030_35GeV_e");
L1EM_eff_1030_35GeV_e->SetMarkerStyle(25);
L1EM_eff_1030_35GeV_e->SetMarkerColor(kBlue);
L1EM_eff_1030_35GeV_e->SetLineColor(kBlue);
L1EM_eff_1030_35GeV_e->Divide(photon_w_L1EM_35GeV_1030_e,all_photons_1030_e,1,1,"B");

TH1D *L1EM_eff_3050_35GeV_e = new TH1D("L1EM_eff_3050_35GeV_b","",40,0,200);
...
L1EM_eff_3050_35GeV_e->Divide(photon_w_L1EM_35GeV_3050_e,all_photons_3050_e,1,1,"B");

TH1D *L1EM_eff_5080_35GeV_e = new TH1D("L1EM_eff_5080_35GeV_e","",40,0,200);
L1EM_eff_5080_35GeV_e->SetName("L1EM_eff_5080_35GeV_e");
L1EM_eff_5080_35GeV_e->SetMarkerStyle(27);
L1EM_eff_5080_35GeV_e->SetMarkerColor(kGreen);
L1EM_eff_5080_35GeV_e->SetLineColor(kGreen);
L1EM_eff_5080_35GeV_e->Divide(photon_w_L1EM_35GeV_5080_e,all_photons_5080_e,1,1,"B");

TPaveText *l1em_photon_03_e = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
l1em_photon_03_e->SetTextSize(0.03);
l1em_photon_03_e->SetFillColor(0);
l1em_photon_03_e->SetBorderSize(0);
l1em_photon_03_e->SetShadowColor(0);
l1em_photon_03_e->SetTextAlign(21);
l1em_photon_03_e->AddText("");
l1em_photon_03_e->AddText("Pb+Pb");
l1em_photon_03_e->AddText("Tight Photons");
l1em_photon_03_e->AddText("p^{#gamma}_{T} > 15 GeV");
l1em_photon_03_e->AddText("L1 RoI p_{T} > 35 GeV");
l1em_photon_03_e->AddText("DeltaR < 0.15");
l1em_photon_03_e->AddText("1.56 < |#eta| < 2.37");
l1em_photon_03_e->SetTextSize(0.036);



L1EM_eff_010_35GeV_e->Draw();
L1EM_eff_1030_35GeV_e->Draw("same");
L1EM_eff_3050_35GeV_e->Draw("same");
L1EM_eff_5080_35GeV_e->Draw("same");

l1em_photon_03_e->Draw("same");

new_lg_l1em_cent_35_e->AddEntry("L1EM_eff_010_35GeV_e","0-10%","pe");
new_lg_l1em_cent_35_e->AddEntry("L1EM_eff_1030_35GeV_e","10-30%","pe");
new_lg_l1em_cent_35_e->AddEntry("L1EM_eff_3050_35GeV_e","30-50%","pe");
new_lg_l1em_cent_35_e->AddEntry("L1EM_eff_5080_35GeV_e","50-80%","pe");


new_lg_l1em_cent_35_e->Draw("same");



//-------------------------------------------------------------------//
//-------------HLT Efficiency Dependent on Centrality---------------//
//-------------------------------------------------------------------//


TCanvas *new_hlt_pT_dis = new TCanvas("new_hlt_pT_dis","new_hlt_pT_dis",600,500);
TLegend *pT_new_dis_hlt = new TLegend(0.6,0.5,0.85,0.6);

photon_w_HLT_15GeV_010->SetName("photon_w_HLT_15GeV_010");
photon_w_HLT_15GeV_010->GetXaxis()->SetTitle("p_{T} [GeV]");
photon_w_HLT_15GeV_010->GetYaxis()->SetTitle("Counts");
photon_w_HLT_15GeV_010->SetLineColor(kRed);
photon_w_HLT_15GeV_010->SetMarkerColor(kRed);
photon_w_HLT_15GeV_010->SetMarkerStyle(24);

photon_w_HLT_15GeV_1030->SetLineColor(kBlue);
photon_w_HLT_15GeV_1030->SetMarkerColor(kBlue);
photon_w_HLT_15GeV_1030->SetMarkerStyle(25);

photon_w_HLT_15GeV_3050->SetLineColor(kMagenta);
photon_w_HLT_15GeV_3050->SetMarkerColor(kMagenta);
photon_w_HLT_15GeV_3050->SetMarkerStyle(26);
...
photon_w_HLT_15GeV_010->Draw();
photon_w_HLT_15GeV_1030->Draw("same");
photon_w_HLT_15GeV_3050->Draw("same");
photon_w_HLT_15GeV_5080->Draw("same");

TPaveText *hlt_photon_00 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
hlt_photon_00->SetTextSize(0.03);
hlt_photon_00->SetFillColor(0);
hlt_photon_00->SetBorderSize(0);
hlt_photon_00->SetShadowColor(0);
hlt_photon_00->SetTextAlign(21);
hlt_photon_00->AddText("");
hlt_photon_00->AddText("Pb+Pb");
hlt_photon_00->AddText("Tight Photons");
hlt_photon_00->AddText("p^{#gamma}_{T} > 15 GeV");
hlt_photon_00->AddText("L1 RoI p_{T} > 15 GeV");
hlt_photon_00->AddText("DeltaR < 0.15");
hlt_photon_00->SetTextSize(0.036);

hlt_photon_00->Draw("same");


pT_new_dis_hlt->AddEntry("photon_w_HLT_15GeV_010","0-10%","l");
pT_new_dis_hlt->AddEntry("photon_w_HLT_15GeV_1030","10-30%", "l");
pT_new_dis_hlt->AddEntry("photon_w_HLT_15GeV_3050","30-50%","l");
pT_new_dis_hlt->AddEntry("photon_w_HLT_15GeV_5080","50-80%","l");
pT_new_dis_hlt->SetTextSize(0.03);
pT_new_dis_hlt->Draw("same");
...
TH1D* HLT_eff_010 = new TH1D("HLT_eff_010","",40,0,200);
HLT_eff_010->SetName("HLT_eff_010");                                                                                                                           
HLT_eff_010->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010->SetMarkerStyle(24);
HLT_eff_010->SetTitle("HLT Efficiency");
HLT_eff_010->SetLineColor(kRed);
HLT_eff_010->SetMarkerColor(kRed);
HLT_eff_010->Divide(photon_w_HLT_15GeV_010,all_photons_010,1,1,"B");
HLT_eff_010->SetMaximum(1.1);

TH1D *HLT_eff_1030 = new TH1D("HLT_eff_1030","",40,0,200);
HLT_eff_1030->SetName("HLT_eff_1030");
HLT_eff_1030->SetMarkerStyle(25);
HLT_eff_1030->SetMarkerColor(kBlue);
HLT_eff_1030->SetLineColor(kBlue);
HLT_eff_1030->Divide(photon_w_HLT_15GeV_1030,all_photons_1030,1,1,"B");

TH1D *HLT_eff_3050 = new TH1D("HLT_eff_3050","",40,0,200);
HLT_eff_3050->SetName("HLT_eff_3050");
HLT_eff_3050->SetMarkerStyle(26);
HLT_eff_3050->SetMarkerColor(kMagenta);
HLT_eff_3050->SetLineColor(kMagenta);
HLT_eff_3050->Divide(photon_w_HLT_15GeV_3050,all_photons_3050,1,1,"B");

TH1D *HLT_eff_5080 = new TH1D("HLT_eff_5080","",40,0,200);
HLT_eff_5080->SetName("HLT_eff_5080");
HLT_eff_5080->SetMarkerStyle(27);
HLT_eff_5080->SetMarkerColor(kGreen);
HLT_eff_5080->SetLineColor(kGreen);
HLT_eff_5080->Divide(photon_w_HLT_15GeV_5080,all_photons_5080,1,1,"B");
...
hlt_photon_0->AddText("HLT p_{T} > 15 GeV");
...
HLT_eff_010->Draw();
HLT_eff_1030->Draw("same");
HLT_eff_3050->Draw("same");
HLT_eff_5080->Draw("same");

hlt_photon_0->Draw("same");

new_lg_hlt_cent->AddEntry("HLT_eff_010","0-10%","pe");
new_lg_hlt_cent->AddEntry("HLT_eff_1030","10-30%","pe");
new_lg_hlt_cent->AddEntry("HLT_eff_3050","30-50%","pe");
new_lg_hlt_cent->AddEntry("HLT_eff_5080","50-80%","pe");
...
//------HLT pT > 25 GeV
TCanvas *new_hlt_eff_cent_25 = new TCanvas("new_hlt_eff_cent_25","new_hlt_eff_cent_25",600,500);
TLegend *new_lg_hlt_cent_25 = new TLegend(0.6,0.5,0.85,0.6);

TH1D* HLT_eff_010_25GeV = new TH1D("HLT_eff_010_25GeV","",40,0,200);
HLT_eff_010_25GeV->SetName("HLT_eff_010_25GeV");                                                                                                                           
HLT_eff_010_25GeV->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_25GeV->SetMarkerStyle(24);
HLT_eff_010_25GeV->SetTitle("HLT Efficiency");
HLT_eff_010_25GeV->SetLineColor(kRed);
HLT_eff_010_25GeV->SetMarkerColor(kRed);
HLT_eff_010_25GeV->Divide(photon_w_HLT_25GeV_010,all_photons_010,1,1,"B");
HLT_eff_010_25GeV->SetMaximum(1.1);

TH1D *HLT_eff_1030_25GeV = new TH1D("HLT_eff_1030","",40,0,200);
...
HLT_eff_1030_25GeV->Divide(photon_w_HLT_25GeV_1030,all_photons_1030,1,1,"B");

TH1D *HLT_eff_3050_25GeV = new TH1D("HLT_eff_3050","",40,0,200);
HLT_eff_3050_25GeV->SetName("HLT_eff_3050_25GeV");
HLT_eff_3050_25GeV->SetMarkerStyle(26);
HLT_eff_3050_25GeV->SetMarkerColor(kMagenta);
HLT_eff_3050_25GeV->SetLineColor(kMagenta);
HLT_eff_3050_25GeV->Divide(photon_w_HLT_25GeV_3050,all_photons_3050,1,1,"B");

TH1D *HLT_eff_5080_25GeV = new TH1D("HLT_eff_5080_25GeV","",40,0,200);
HLT_eff_5080_25GeV->SetName("HLT_eff_5080_25GeV");
HLT_eff_5080_25GeV->SetMarkerStyle(27);
HLT_eff_5080_25GeV->SetMarkerColor(kGreen);
HLT_eff_5080_25GeV->SetLineColor(kGreen);
HLT_eff_5080_25GeV->Divide(photon_w_HLT_25GeV_5080,all_photons_5080,1,1,"B");

TPaveText *hlt_photon_01 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
hlt_photon_01->SetTextSize(0.03);
hlt_photon_01->SetFillColor(0);
hlt_photon_01->SetBorderSize(0);
hlt_photon_01->SetShadowColor(0);
hlt_photon_01->SetTextAlign(21);
hlt_photon_01->AddText("");
hlt_photon_01->AddText("Pb+Pb");
hlt_photon_01->AddText("Tight Photons");
hlt_photon_01->AddText("p^{#gamma}_{T} > 15 GeV");
hlt_photon_01->AddText("HLT Loose Photons");
hlt_photon_01->AddText("HLT p_{T} > 25 GeV");
hlt_photon_01->AddText("DeltaR < 0.15");
hlt_photon_01->SetTextSize(0.036);





HLT_eff_010_25GeV->Draw();
HLT_eff_1030_25GeV->Draw("same");
HLT_eff_3050_25GeV->Draw("same");
HLT_eff_5080_25GeV->Draw("same");

hlt_photon_01->Draw("same");

new_lg_hlt_cent_25->AddEntry("HLT_eff_010_25GeV","0-10%","pe");
new_lg_hlt_cent_25->AddEntry("HLT_eff_1030_25GeV","10-30%","pe");
new_lg_hlt_cent_25->AddEntry("HLT_eff_3050_25GeV","30-50%","pe");
new_lg_hlt_cent_25->AddEntry("HLT_eff_5080_25GeV","50-80%","pe");


new_lg_hlt_cent_25->Draw("same");


//------HLT pT > 35 GeV
TCanvas *new_hlt_eff_cent_35 = new TCanvas("new_hlt_eff_cent_35","new_hlt_eff_cent_35",600,500);
TLegend *new_lg_hlt_cent_35 = new TLegend(0.6,0.5,0.85,0.6);

TH1D* HLT_eff_010_35GeV = new TH1D("HLT_eff_010_35GeV","",40,0,200);
HLT_eff_010_35GeV->SetName("HLT_eff_010_35GeV");                                                                                                                           
HLT_eff_010_35GeV->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_35GeV->SetMarkerStyle(24);
HLT_eff_010_35GeV->SetTitle("HLT Efficiency");
HLT_eff_010_35GeV->SetLineColor(kRed);
HLT_eff_010_35GeV->SetMarkerColor(kRed);
HLT_eff_010_35GeV->Divide(photon_w_HLT_35GeV_010,all_photons_010,1,1,"B");
HLT_eff_010_35GeV->SetMaximum(1.1);

TH1D *HLT_eff_1030_35GeV = new TH1D("HLT_eff_1030_35GeV","",40,0,200);
HLT_eff_1030_35GeV->SetName("HLT_eff_1030_35GeV");
HLT_eff_1030_35GeV->SetMarkerStyle(25);
HLT_eff_1030_35GeV->SetMarkerColor(kBlue);
HLT_eff_1030_35GeV->SetLineColor(kBlue);
HLT_eff_1030_35GeV->Divide(photon_w_HLT_35GeV_1030,all_photons_1030,1,1,"B");

TH1D *HLT_eff_3050_35GeV = new TH1D("HLT_eff_3050","",40,0,200);
...
HLT_eff_3050_35GeV->Divide(photon_w_HLT_35GeV_3050,all_photons_3050,1,1,"B");

TH1D *HLT_eff_5080_35GeV = new TH1D("HLT_eff_5080_35GeV","",40,0,200);
HLT_eff_5080_35GeV->SetName("HLT_eff_5080_35GeV");
HLT_eff_5080_35GeV->SetMarkerStyle(27);
HLT_eff_5080_35GeV->SetMarkerColor(kGreen);
HLT_eff_5080_35GeV->SetLineColor(kGreen);
HLT_eff_5080_35GeV->Divide(photon_w_HLT_35GeV_5080,all_photons_5080,1,1,"B");

TPaveText *hlt_photon_02 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
hlt_photon_02->SetTextSize(0.03);
hlt_photon_02->SetFillColor(0);
hlt_photon_02->SetBorderSize(0);
hlt_photon_02->SetShadowColor(0);
hlt_photon_02->SetTextAlign(21);
hlt_photon_02->AddText("");
hlt_photon_02->AddText("Pb+Pb");
hlt_photon_02->AddText("Tight Photons");
hlt_photon_02->AddText("p^{#gamma}_{T} > 15 GeV");
hlt_photon_02->AddText("HLT Loose Photons");
hlt_photon_02->AddText("HLT p_{T} > 35 GeV");
hlt_photon_02->AddText("DeltaR < 0.15");
hlt_photon_02->SetTextSize(0.036);



HLT_eff_010_35GeV->Draw();
HLT_eff_1030_35GeV->Draw("same");
HLT_eff_3050_35GeV->Draw("same");
HLT_eff_5080_35GeV->Draw("same");

hlt_photon_02->Draw("same");

new_lg_hlt_cent_35->AddEntry("HLT_eff_010_35GeV","0-10%","pe");
new_lg_hlt_cent_35->AddEntry("HLT_eff_1030_35GeV","10-30%","pe");
new_lg_hlt_cent_35->AddEntry("HLT_eff_3050_35GeV","30-50%","pe");
new_lg_hlt_cent_35->AddEntry("HLT_eff_5080_35GeV","50-80%","pe");

new_lg_hlt_cent_35->SetBorderSize(0);

new_lg_hlt_cent_35->Draw("same");
...
TH1D* HLT_eff_010_b = new TH1D("HLT_eff_010_b","",40,0,200);
HLT_eff_010_b->SetName("HLT_eff_010_b");                                                                                                                           
HLT_eff_010_b->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_b->SetMarkerStyle(24);
HLT_eff_010_b->SetTitle("HLT Efficiency");
HLT_eff_010_b->SetLineColor(kRed);
HLT_eff_010_b->SetMarkerColor(kRed);
HLT_eff_010_b->Divide(photon_w_HLT_15GeV_010_b,all_photons_010_b,1,1,"B");
HLT_eff_010_b->SetMaximum(1.1);

TH1D *HLT_eff_1030_b = new TH1D("HLT_eff_1030_b","",40,0,200);
HLT_eff_1030_b->SetName("HLT_eff_1030_b");
HLT_eff_1030_b->SetMarkerStyle(25);
HLT_eff_1030_b->SetMarkerColor(kBlue);
HLT_eff_1030_b->SetLineColor(kBlue);
HLT_eff_1030_b->Divide(photon_w_HLT_15GeV_1030_b,all_photons_1030_b,1,1,"B");

TH1D *HLT_eff_3050_b = new TH1D("HLT_eff_3050_b","",40,0,200);
HLT_eff_3050_b->SetName("HLT_eff_3050_b");
HLT_eff_3050_b->SetMarkerStyle(26);
HLT_eff_3050_b->SetMarkerColor(kMagenta);
HLT_eff_3050_b->SetLineColor(kMagenta);
HLT_eff_3050_b->Divide(photon_w_HLT_15GeV_3050_b,all_photons_3050_b,1,1,"B");

TH1D *HLT_eff_5080_b = new TH1D("HLT_eff_5080_b","",40,0,200);
HLT_eff_5080_b->SetName("HLT_eff_5080_b");
HLT_eff_5080_b->SetMarkerStyle(27);
HLT_eff_5080_b->SetMarkerColor(kGreen);
HLT_eff_5080_b->SetLineColor(kGreen);
HLT_eff_5080_b->Divide(photon_w_HLT_15GeV_5080_b,all_photons_5080_b,1,1,"B");
...
hlt_photon_0_b->AddText("HLT Loose Photons");
hlt_photon_0_b->AddText("HLT p_{T} > 15 GeV");
...
HLT_eff_010_b->Draw();
HLT_eff_1030_b->Draw("same");
HLT_eff_3050_b->Draw("same");
HLT_eff_5080_b->Draw("same");

hlt_photon_0_b->Draw("same");

new_lg_hlt_cent_b->AddEntry("HLT_eff_010_b","0-10%","pe");
new_lg_hlt_cent_b->AddEntry("HLT_eff_1030_b","10-30%","pe");
new_lg_hlt_cent_b->AddEntry("HLT_eff_3050_b","30-50%","pe");
new_lg_hlt_cent_b->AddEntry("HLT_eff_5080_b","50-80%","pe");
...
//------L1EM pT > 25 GeV
TCanvas *new_hlt_eff_cent_25_b = new TCanvas("new_hlt_eff_cent_25_b","new_hlt_eff_cent_25_b",600,500);
TLegend *new_lg_hlt_cent_25_b = new TLegend(0.6,0.5,0.85,0.6);

TH1D* HLT_eff_010_25GeV_b = new TH1D("HLT_eff_010_25GeV_b","",40,0,200);
HLT_eff_010_25GeV_b->SetName("HLT_eff_010_25GeV_b");                                                                                                                           
HLT_eff_010_25GeV_b->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_25GeV_b->SetMarkerStyle(24);
HLT_eff_010_25GeV_b->SetTitle("HLT Efficiency");
HLT_eff_010_25GeV_b->SetLineColor(kRed);
HLT_eff_010_25GeV_b->SetMarkerColor(kRed);
HLT_eff_010_25GeV_b->Divide(photon_w_HLT_25GeV_010_b,all_photons_010_b,1,1,"B");
HLT_eff_010_25GeV_b->SetMaximum(1.1);

TH1D *HLT_eff_1030_25GeV_b = new TH1D("L1EM_eff_1030_25GeV_b","",40,0,200);
...
HLT_eff_1030_25GeV_b->Divide(photon_w_HLT_25GeV_1030_b,all_photons_1030_b,1,1,"B");

TH1D *HLT_eff_3050_25GeV_b = new TH1D("HLT_eff_3050_25GeV_b","",40,0,200);
HLT_eff_3050_25GeV_b->SetName("HLT_eff_3050_25GeV_b");
HLT_eff_3050_25GeV_b->SetMarkerStyle(26);
HLT_eff_3050_25GeV_b->SetMarkerColor(kMagenta);
HLT_eff_3050_25GeV_b->SetLineColor(kMagenta);
HLT_eff_3050_25GeV_b->Divide(photon_w_HLT_25GeV_3050_b,all_photons_3050_b,1,1,"B");

TH1D *HLT_eff_5080_25GeV_b = new TH1D("HLT_eff_5080_25GeV_b","",40,0,200);
HLT_eff_5080_25GeV_b->SetName("HLT_eff_5080_25GeV_b");
HLT_eff_5080_25GeV_b->SetMarkerStyle(27);
HLT_eff_5080_25GeV_b->SetMarkerColor(kGreen);
HLT_eff_5080_25GeV_b->SetLineColor(kGreen);
HLT_eff_5080_25GeV_b->Divide(photon_w_HLT_25GeV_5080_b,all_photons_5080_b,1,1,"B");

TPaveText *hlt_photon_01_b = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
hlt_photon_01_b->SetTextSize(0.03);
hlt_photon_01_b->SetFillColor(0);
hlt_photon_01_b->SetBorderSize(0);
hlt_photon_01_b->SetShadowColor(0);
hlt_photon_01_b->SetTextAlign(21);
hlt_photon_01_b->AddText("");
hlt_photon_01_b->AddText("Pb+Pb");
hlt_photon_01_b->AddText("Tight Photons");
hlt_photon_01_b->AddText("p^{#gamma}_{T} > 15 GeV");
hlt_photon_01_b->AddText("HLT Loose Photons");
hlt_photon_01_b->AddText("HLT p_{T} > 25 GeV");
hlt_photon_01_b->AddText("DeltaR < 0.15");
hlt_photon_01_b->AddText("|#eta| < 1.37");
hlt_photon_01_b->SetTextSize(0.036);





HLT_eff_010_25GeV_b->Draw();
HLT_eff_1030_25GeV_b->Draw("same");
HLT_eff_3050_25GeV_b->Draw("same");
HLT_eff_5080_25GeV_b->Draw("same");

hlt_photon_01_b->Draw("same");

new_lg_hlt_cent_25_b->AddEntry("HLT_eff_010_25GeV_b","0-10%","pe");
new_lg_hlt_cent_25_b->AddEntry("HLT_eff_1030_25GeV_b","10-30%","pe");
new_lg_hlt_cent_25_b->AddEntry("HLT_eff_3050_25GeV_b","30-50%","pe");
new_lg_hlt_cent_25_b->AddEntry("HLT_eff_5080_25GeV_b","50-80%","pe");


new_lg_hlt_cent_25_b->Draw("same");

//////*********************************RE CHECK THIS PART. NO BUENOOOOOO**********************************//
//------L1EM pT > 35 GeV
TCanvas *new_hlt_eff_cent_35_b = new TCanvas("new_hlt_eff_cent_35_b","new_hlt_eff_cent_35_b",600,500);
TLegend *new_lg_hlt_cent_35_b = new TLegend(0.6,0.5,0.85,0.6);

TH1D* HLT_eff_010_35GeV_b = new TH1D("HLT_eff_010_35GeV_b","",40,0,200);
HLT_eff_010_35GeV_b->SetName("HLT_eff_010_35GeV_b");                                                                                                                           
HLT_eff_010_35GeV_b->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_35GeV_b->SetMarkerStyle(24);
HLT_eff_010_35GeV_b->SetTitle("HLT Efficiency");
HLT_eff_010_35GeV_b->SetLineColor(kRed);
HLT_eff_010_35GeV_b->SetMarkerColor(kRed);
HLT_eff_010_35GeV_b->Divide(photon_w_HLT_35GeV_010_b,all_photons_010_b,1,1,"B");
HLT_eff_010_35GeV_b->SetMaximum(1.1);

TH1D *HLT_eff_1030_35GeV_b = new TH1D("HLT_eff_1030_35GeV_b","",40,0,200);
HLT_eff_1030_35GeV_b->SetName("HLT_eff_1030_35GeV_b");
HLT_eff_1030_35GeV_b->SetMarkerStyle(25);
HLT_eff_1030_35GeV_b->SetMarkerColor(kBlue);
HLT_eff_1030_35GeV_b->SetLineColor(kBlue);
HLT_eff_1030_35GeV_b->Divide(photon_w_HLT_35GeV_1030_b,all_photons_1030_b,1,1,"B");

TH1D *HLT_eff_3050_35GeV_b = new TH1D("HLT_eff_3050_35GeV_b","",40,0,200);
...
HLT_eff_3050_35GeV_b->Divide(photon_w_HLT_35GeV_3050_b,all_photons_3050_b,1,1,"B");

TH1D *HLT_eff_5080_35GeV_b = new TH1D("HLT_eff_5080_35GeV_b","",40,0,200);
HLT_eff_5080_35GeV_b->SetName("HLT_eff_5080_35GeV_b");
HLT_eff_5080_35GeV_b->SetMarkerStyle(27);
HLT_eff_5080_35GeV_b->SetMarkerColor(kGreen);
HLT_eff_5080_35GeV_b->SetLineColor(kGreen);
HLT_eff_5080_35GeV_b->Divide(photon_w_HLT_35GeV_5080_b,all_photons_5080_b,1,1,"B");

TPaveText *hlt_photon_03 = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
hlt_photon_03->SetTextSize(0.03);
hlt_photon_03->SetFillColor(0);
hlt_photon_03->SetBorderSize(0);
hlt_photon_03->SetShadowColor(0);
hlt_photon_03->SetTextAlign(21);
hlt_photon_03->AddText("");
hlt_photon_03->AddText("Pb+Pb");
hlt_photon_03->AddText("Tight Photons");
hlt_photon_03->AddText("p^{#gamma}_{T} > 15 GeV");
hlt_photon_03->AddText("HLT Loose Photons");
hlt_photon_03->AddText("HLT p_{T} > 35 GeV");
hlt_photon_03->AddText("DeltaR < 0.15");
hlt_photon_03->AddText("|#eta| < 1.37");
hlt_photon_03->SetTextSize(0.036);



HLT_eff_010_35GeV_b->Draw();
HLT_eff_1030_35GeV_b->Draw("same");
HLT_eff_3050_35GeV_b->Draw("same");
HLT_eff_5080_35GeV_b->Draw("same");

hlt_photon_03->Draw("same");

new_lg_hlt_cent_35_b->AddEntry("HLT_eff_010_35GeV_b","0-10%","pe");
new_lg_hlt_cent_35_b->AddEntry("HLT_eff_1030_35GeV_b","10-30%","pe");
new_lg_hlt_cent_35_b->AddEntry("HLT_eff_3050_35GeV_b","30-50%","pe");
new_lg_hlt_cent_35_b->AddEntry("HLT_eff_5080_35GeV_b","50-80%","pe");


new_lg_hlt_cent_35_b->Draw("same");
...
TH1D* HLT_eff_010_e = new TH1D("HLT_eff_010_e","",40,0,200);
HLT_eff_010_e->SetName("HLT_eff_010_e");                                                                                                                           
HLT_eff_010_e->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_e->SetMarkerStyle(24);
HLT_eff_010_e->SetTitle("HLT Efficiency");
HLT_eff_010_e->SetLineColor(kRed);
HLT_eff_010_e->SetMarkerColor(kRed);
HLT_eff_010_e->Divide(photon_w_HLT_15GeV_010_e,all_photons_010_e,1,1,"B");
HLT_eff_010_e->SetMaximum(1.1);

TH1D *HLT_eff_1030_e = new TH1D("HLT_eff_1030_e","",40,0,200);
HLT_eff_1030_e->SetName("HLT_eff_1030_e");
HLT_eff_1030_e->SetMarkerStyle(25);
HLT_eff_1030_e->SetMarkerColor(kBlue);
HLT_eff_1030_e->SetLineColor(kBlue);
HLT_eff_1030_e->Divide(photon_w_HLT_15GeV_1030_e,all_photons_1030_e,1,1,"B");

TH1D *HLT_eff_3050_e = new TH1D("HLT_eff_3050_e","",40,0,200);
HLT_eff_3050_e->SetName("HLT_eff_3050_e");
HLT_eff_3050_e->SetMarkerStyle(26);
HLT_eff_3050_e->SetMarkerColor(kMagenta);
HLT_eff_3050_e->SetLineColor(kMagenta);
HLT_eff_3050_e->Divide(photon_w_HLT_15GeV_3050_e,all_photons_3050_e,1,1,"B");

TH1D *HLT_eff_5080_e = new TH1D("HLT_eff_5080_e","",40,0,200);
HLT_eff_5080_e->SetName("HLT_eff_5080_e");
HLT_eff_5080_e->SetMarkerStyle(27);
HLT_eff_5080_e->SetMarkerColor(kGreen);
HLT_eff_5080_e->SetLineColor(kGreen);
HLT_eff_5080_e->Divide(photon_w_HLT_15GeV_5080_e,all_photons_5080_e,1,1,"B");
...
hlt_photon_0_e->AddText("HLT Loose Photons");
hlt_photon_0_e->AddText("HLT p_{T} > 15 GeV");
...
HLT_eff_010_e->Draw();
HLT_eff_1030_e->Draw("same");
HLT_eff_3050_e->Draw("same");
HLT_eff_5080_e->Draw("same");

hlt_photon_0_e->Draw("same");

new_lg_hlt_cent_e->AddEntry("HLT_eff_010_e","0-10%","pe");
new_lg_hlt_cent_e->AddEntry("HLT_eff_1030_e","10-30%","pe");
new_lg_hlt_cent_e->AddEntry("HLT_eff_3050_e","30-50%","pe");
new_lg_hlt_cent_e->AddEntry("HLT_eff_5080_e","50-80%","pe");
...
//------HLT pT > 25 GeV
TCanvas *new_hlt_eff_cent_25_e = new TCanvas("new_hlt_eff_cent_25_e","new_hlt_eff_cent_25_e",600,500);
TLegend *new_lg_hlt_cent_25_e = new TLegend(0.6,0.5,0.85,0.6);

TH1D* HLT_eff_010_25GeV_e = new TH1D("HLT_eff_010_25GeV_e","",40,0,200);
HLT_eff_010_25GeV_e->SetName("HLT_eff_010_25GeV_e");                                                                                                                           
HLT_eff_010_25GeV_e->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_25GeV_e->SetMarkerStyle(24);
HLT_eff_010_25GeV_e->SetTitle("HLT Efficiency");
HLT_eff_010_25GeV_e->SetLineColor(kRed);
HLT_eff_010_25GeV_e->SetMarkerColor(kRed);
HLT_eff_010_25GeV_e->Divide(photon_w_HLT_25GeV_010_e,all_photons_010_e,1,1,"B");
HLT_eff_010_25GeV_e->SetMaximum(1.1);

TH1D *HLT_eff_1030_25GeV_e = new TH1D("HLT_eff_1030_25GeV_e","",40,0,200);
HLT_eff_1030_25GeV_e->SetName("HLT_eff_1030_25GeV_e");
HLT_eff_1030_25GeV_e->SetMarkerStyle(25);
HLT_eff_1030_25GeV_e->SetMarkerColor(kBlue);
HLT_eff_1030_25GeV_e->SetLineColor(kBlue);
HLT_eff_1030_25GeV_e->Divide(photon_w_HLT_25GeV_1030_e,all_photons_1030_e,1,1,"B");

TH1D *HLT_eff_3050_25GeV_e = new TH1D("HLT_eff_3050_25GeV_e","",40,0,200);
HLT_eff_3050_25GeV_e->SetName("HLT_eff_3050_25GeV_e");
HLT_eff_3050_25GeV_e->SetMarkerStyle(26);
HLT_eff_3050_25GeV_e->SetMarkerColor(kMagenta);
HLT_eff_3050_25GeV_e->SetLineColor(kMagenta);
HLT_eff_3050_25GeV_e->Divide(photon_w_HLT_25GeV_3050_e,all_photons_3050_e,1,1,"B");

TH1D *HLT_eff_5080_25GeV_e = new TH1D("HLT_eff_5080_25GeV_e","",40,0,200);
HLT_eff_5080_25GeV_e->SetName("HLT_eff_5080_25GeV_e");
HLT_eff_5080_25GeV_e->SetMarkerStyle(27);
HLT_eff_5080_25GeV_e->SetMarkerColor(kGreen);
HLT_eff_5080_25GeV_e->SetLineColor(kGreen);
HLT_eff_5080_25GeV_e->Divide(photon_w_HLT_25GeV_5080_e,all_photons_5080_e,1,1,"B");

TPaveText *hlt_photon_01_e = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
hlt_photon_01_e->SetTextSize(0.03);
hlt_photon_01_e->SetFillColor(0);
hlt_photon_01_e->SetBorderSize(0);
hlt_photon_01_e->SetShadowColor(0);
hlt_photon_01_e->SetTextAlign(21);
hlt_photon_01_e->AddText("");
hlt_photon_01_e->AddText("Pb+Pb");
hlt_photon_01_e->AddText("Tight Photons");
hlt_photon_01_e->AddText("p^{#gamma}_{T} > 15 GeV");
hlt_photon_01_e->AddText("HLT Loose Photons");
hlt_photon_01_e->AddText("HLT p_{T} > 25 GeV");
hlt_photon_01_e->AddText("DeltaR < 0.15");
hlt_photon_01_e->AddText("1.56 < |#eta| < 2.37");
hlt_photon_01_e->SetTextSize(0.036);





HLT_eff_010_25GeV_e->Draw();
HLT_eff_1030_25GeV_e->Draw("same");
HLT_eff_3050_25GeV_e->Draw("same");
HLT_eff_5080_25GeV_e->Draw("same");

hlt_photon_01_e->Draw("same");

new_lg_hlt_cent_25_e->AddEntry("HLT_eff_010_25GeV_e","0-10%","pe");
new_lg_hlt_cent_25_e->AddEntry("HLT_eff_1030_25GeV_e","10-30%","pe");
new_lg_hlt_cent_25_e->AddEntry("HLT_eff_3050_25GeV_e","30-50%","pe");
new_lg_hlt_cent_25_e->AddEntry("HLT_eff_5080_25GeV_e","50-80%","pe");


new_lg_hlt_cent_25_e->Draw("same");


//------HLT pT > 35 GeV
TCanvas *new_hlt_eff_cent_35_e = new TCanvas("new_hlt_eff_cent_35_e","new_hlt_eff_cent_35_e",600,500);
TLegend *new_lg_hlt_cent_35_e = new TLegend(0.6,0.5,0.85,0.6);

TH1D* HLT_eff_010_35GeV_e = new TH1D("HLT_eff_010_35GeV_e","",40,0,200);
HLT_eff_010_35GeV_e->SetName("HLT_eff_010_35GeV_e");                                                                                                                           
HLT_eff_010_35GeV_e->GetXaxis()->SetTitle("p_{T} [GeV]");
HLT_eff_010_35GeV_e->SetMarkerStyle(24);
HLT_eff_010_35GeV_e->SetTitle("HLT Efficiency");
HLT_eff_010_35GeV_e->SetLineColor(kRed);
HLT_eff_010_35GeV_e->SetMarkerColor(kRed);
HLT_eff_010_35GeV_e->Divide(photon_w_HLT_35GeV_010_e,all_photons_010_e,1,1,"B");
HLT_eff_010_35GeV_e->SetMaximum(1.1);

TH1D *HLT_eff_1030_35GeV_e = new TH1D("HLT_eff_1030_35GeV_e","",40,0,200);
HLT_eff_1030_35GeV_e->SetName("HLT_eff_1030_35GeV_e");
HLT_eff_1030_35GeV_e->SetMarkerStyle(25);
HLT_eff_1030_35GeV_e->SetMarkerColor(kBlue);
HLT_eff_1030_35GeV_e->SetLineColor(kBlue);
HLT_eff_1030_35GeV_e->Divide(photon_w_HLT_35GeV_1030_e,all_photons_1030_e,1,1,"B");

TH1D *HLT_eff_3050_35GeV_e = new TH1D("HLT_eff_3050_35GeV_b","",40,0,200);
...
HLT_eff_3050_35GeV_e->Divide(photon_w_HLT_35GeV_3050_e,all_photons_3050_e,1,1,"B");

TH1D *HLT_eff_5080_35GeV_e = new TH1D("HLT_eff_5080_35GeV_e","",40,0,200);
HLT_eff_5080_35GeV_e->SetName("HLT_eff_5080_35GeV_e");
HLT_eff_5080_35GeV_e->SetMarkerStyle(27);
HLT_eff_5080_35GeV_e->SetMarkerColor(kGreen);
HLT_eff_5080_35GeV_e->SetLineColor(kGreen);
HLT_eff_5080_35GeV_e->Divide(photon_w_HLT_35GeV_5080_e,all_photons_5080_e,1,1,"B");

TPaveText *hlt_photon_03_e = new TPaveText(0.57,0.68,0.77,0.88,"NDC");
hlt_photon_03_e->SetTextSize(0.03);
hlt_photon_03_e->SetFillColor(0);
hlt_photon_03_e->SetBorderSize(0);
hlt_photon_03_e->SetShadowColor(0);
hlt_photon_03_e->SetTextAlign(21);
hlt_photon_03_e->AddText("");
hlt_photon_03_e->AddText("Pb+Pb");
hlt_photon_03_e->AddText("Tight Photons");
hlt_photon_03_e->AddText("p^{#gamma}_{T} > 15 GeV");
hlt_photon_03_e->AddText("HLT Loose Photons");
hlt_photon_03_e->AddText("HLT p_{T} > 35 GeV");
hlt_photon_03_e->AddText("DeltaR < 0.15");
hlt_photon_03_e->AddText("1.56 < |#eta| < 2.37");
hlt_photon_03_e->SetTextSize(0.036);



HLT_eff_010_35GeV_e->Draw();
HLT_eff_1030_35GeV_e->Draw("same");
HLT_eff_3050_35GeV_e->Draw("same");
HLT_eff_5080_35GeV_e->Draw("same");

hlt_photon_03_e->Draw("same");

new_lg_hlt_cent_35_e->AddEntry("HLT_eff_010_35GeV_e","0-10%","pe");
new_lg_hlt_cent_35_e->AddEntry("HLT_eff_1030_35GeV_e","10-30%","pe");
new_lg_hlt_cent_35_e->AddEntry("HLT_eff_3050_35GeV_e","30-50%","pe");
new_lg_hlt_cent_35_e->AddEntry("HLT_eff_5080_35GeV_e","50-80%","pe");


new_lg_hlt_cent_35_e->Draw("same");
